...
class MultipleRegression extends React.Component {  
 constructor(props) {
    ...
    multipleregression() {
      ...
      // var order = document.getElementById('xx').value
          ...
          var result = regression(xArr);
          console.log(result)
                 
         
          document.getElementById('ans').innerHTML='y = '+result[1]+'x^2'+result[0];
...
export default withRouter(MultipleRegression)
