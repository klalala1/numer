...
addStyles();var fxx=latex_to_js('\\left(\\frac{1}{2}\\right)\\cdot\\left(\\frac{25}{x}+x\\right)');
const columns = [
  {
      title: "Iteration",
      dataIndex: "iteration",
...
class OnePoint extends React.Component {
    ...
    constructor(props) {
      super(props);
      this.state = {value1: '',value2:'',a:false,fxx:'',latex:'\\left(\\frac{1}{2}\\right)\\cdot\\left(\\frac{25}{x}+x\\right)'};
    ...
    Example = async ()=> {
      ...
      OnePointMethod = (xi, i,ct) => {
       
        var fx=this.state.fxx;var code2;var scope;console.log(fx)
    ...
    else this.OnePointMethod(xinew,i,ct);
    ...
    handleSubmit(event) {
      ...
      console.log("aaaa")
       ...
       data=[];
      this.OnePointMethod(this.state.value1,0,0)
...
<form onSubmit={this.handleSubmit2}>
  ...
  export default  withRouter(OnePoint)