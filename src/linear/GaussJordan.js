...
class GausseJordan extends React.Component {  
      ...
      constructor(props) {
       ...
       // const Classes = makeStyles();
        this.state = {value: '',value2:'',fx:'',rows:[],HelperText:'',x:[ ],y:[],idd:'',valuee:'',valuesubmit:'',dataa:[]};
...
this.setState({dataa:temp})
  ...
  return (
    ...
    <div style={{marginTop:'4%',marginBottom:'4%',width:'85%',marginTop:'5%',marginLeft:'35%',marginBottom:'5%',  minHeight:'80vh', background:'white',border:"4px solid black" ,justifyContent:'center',alignItems:"center",padding:"10px", width:"30vw",}} ><h1>Gausse Jordan</h1>
...
export default withRouter(GausseJordan)
