...
class Gausseelim extends React.Component {  
 ...
 this.setState({dataa:temp})
  ...
  return (
    ...
    <div style={{width:'85%',marginTop:'5%',marginLeft:'35%',marginBottom:'5%',  minHeight:'80vh', background:'white',border:"4px solid black" ,justifyContent:'center',alignItems:"center",padding:"10px", width:"30vw",}} > <h1 >Gausse Elimination </h1>
...
export default withRouter(Gausseelim)
